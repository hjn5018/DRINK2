		...
		<div class="user_box join">
			<p class="tit">
				<a href="<c:url value='/index.do'/>"> <img
					src="<c:url value='/itman_static/_img/itman_logo.png'/>" alt="아이티맨" />
				</a>
			</p>
			<ul class="step">
				...
				<li>
					...
					<div>
						<div class="mem_agree userPriv">
							...
							<ul class="prv_list">
								<li>1. 이메일, 이름, 광고성 정보 수신 동의 여부, 타 서비스 로그인 고유번호, 연계정보(CI, DI)
							...
							<p class="prv_sub">회사는 서비스를 제공하는 동안 개인정보 취급방침 및 관련법에 의거하여 회원의
								개인정보를 지속적으로 관리 및 보관합니다. 탈퇴 등으로 인해 개인정보 수집 및 이용목적이 달성될 경우, 수집 된
								개인정보는 즉시 또는 아래와 같이 일정 기간 이후 파기됩니다.</p>
							<ul class="prv_list">
								<li>1. 가입 시 수집된 개인정보 : 탈퇴 후 14일</li>
								<li>2. 로그기록 : 최대 3년 <span>※ 위 항에도 불구하고 법령에 의해 개인정보를 보관할 경우, 해당 법령에서 정한 최대 기간만큼 저장합니다.</span>
								...
								<span>※ 회원이 1년 이상 로그인 및 접속을 하지 않을 경우, 해당 계정은 휴면 계정으로 전환됩니다. 개인정보의 안전한
										처리를 위해 휴면 계정의 학교, 아이디, 이메일, 이름, 닉네임, 입학 년도, 연계정보는 분리 보관되며, 이외의
										개인정보 및 이용기록은 모두 파기될 수 있습니다.
										<br />
							...
							<p class="prv_sub">
								...
								단, 회사는 보안성 높은 서비스 제공을 위하여, 신뢰도가 검증된 아래 회사에 개인정보 관련 업무 처리를 위탁할 수 있습니다.
								<br/> <br/> 이 경우 회사는 회원에게 위탁을 받는 자와 업무의 내용을 사전에 알리고 동의를 받습니다.
								위탁을 받는 자 또는 업무의 내용이 변경될 경우에도 같습니다.
								회사는 정보통신서비스의 제공에 관한 계약을 이행하고 회원의 편의 증진 등 을 위하여 추가적인 처리 위탁이 필요한 경우에는 고지 및 동의 절차를 거치지 않을 수 있습니다.
							</p>
						</div>
						<p>
							<input type="checkbox" name="ag01" id="ag01"
								onclick='unCheckAll(this)' /><label for="ag01">동의합니다</label>
						</p>
					</div>
				</li>
				<li>
					...
					<div>
						<div class="mem_agree userPriv">
							...
							<p class="prv_sub">1. 불법촬영물 등을 유통할 경우 전기통신사업법 제22조의5제1항에 따른 삭제, 접근 제한 등 유통방지에 필요한 조치가 취해지며, 관련 법률에 따라 처벌을 받을 수 있습니다.
							<p>
							<p class="prv_sub top">2. 불법촬영물, 허위영상물, 아동∙청소년 성착취물 등 불법촬영물로 의심되는 게시물을 발견하셨을 경우, 유해정보신고센터에 신고해주시기 바랍니다.</p>
						</div>
						<p>
							<input type="checkbox" name="ag02" id="ag02"
								onclick='unCheckAll(this)' /><label for="ag02">동의합니다</label>
						</p>
					</div>
				</li>
			</ul>
			<p class="all_check">
				<input type="checkbox" name="selectall" id="ag_all"
					onclick='selectAll(this)' /><label for="ag_all">모두 동의합니다</label>
			</p>
			<p class="user_btn">
				<a href="javascript:fn_submit();">다음</a>
			</p>
		</div>
	</div>
...
<script>
	...
	function selectAll(selectAll)  {
	  const checkboxes1 = document.getElementsByName('ag01');
	  checkboxes1.forEach((checkbox) => {
	    checkbox.checked = selectAll.checked;
	  })

	  const checkboxes2 = document.getElementsByName('ag02');
