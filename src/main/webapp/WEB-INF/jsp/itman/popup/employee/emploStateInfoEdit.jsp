<%-- /WEB-INF/jsp/itman/popup/employee/emploStateInfoEdit.jsp --%>
...
<body>
    ...
    <div id="popup">
        <div class="pop_tit">
            <p class="title">상태 변경</p>
        </div>
        <div class="pop_cont">
            <form:form id="form" method="post" action="${ctx}/popup/employee/emploStateInfoEditProc.do" modelAttribute="emploVO">
