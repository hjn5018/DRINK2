...
<body>
<div id="popup">
    <form method="post" action="<c:url value='/popup/asset/ppProcess/assetNameInfoEditProc.do'/>" id="form">
        ...
        <div class="pop_cont">
            <ul class="contEdit">
                <li>
                    <p class="tit">자산명</p>
                    <p class="cont"><input type="text" id="assName" name="assName" value="${assetVO.assName}"></p>
                </li>
                <li>
                    <p class="tit">비고</p>
