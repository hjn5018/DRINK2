...
<head>
    ...
    <title>최초 구매일 변경</title>
</head>
<body>
<div id="popup">
    <form method="post" action="<c:url value='/popup/asset/ppProcess/assetBuyDateInfoEditProc.do'/>" id="form">
        ...
        <div class="pop_cont">
            <ul class="contEdit">
                <li>
                    ...
                    <p class="cont"><input type="date" id="buyDate" name="buyDate" value="${assetVO.buyDate}"></p>
                </li>
                <li>
                    <p class="tit">비고</p>
